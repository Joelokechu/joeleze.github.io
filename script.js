...
Chat Widget
============================= */
const chatBtn = document.querySelector('button:contains("💬 Chat")') || document.querySelector('button'); // adjust if needed
if (chatBtn) {
const chatWindow = document.createElement("div");
chatWindow.className = "chat-window"; chatBtn.insertAdjacentElement("afterend", chatWindow);
